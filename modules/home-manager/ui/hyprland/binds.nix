      ...
      wayland.windowManager.hyprland.settings =
        ...
        in
        {
          bind = [
            ...
            # dont follow
            "${mod}${shift}${secondary}, 1, movetoworkspacesilent, 1"
            "${mod}${shift}${secondary}, 2, movetoworkspacesilent, 2"
            "${mod}${shift}${secondary}, 3, movetoworkspacesilent, 3"
            "${mod}${shift}${secondary}, 4, movetoworkspacesilent, 4"
            "${mod}${shift}${secondary}, 5, movetoworkspacesilent, 5"
            "${mod}${shift}${secondary}, 6, movetoworkspacesilent, 6"
            "${mod}${shift}${secondary}, 7, movetoworkspacesilent, 7"
            "${mod}${shift}${secondary}, 8, movetoworkspacesilent, 8"
            "${mod}${shift}${secondary}, 9, movetoworkspacesilent, 9"
            "${mod}${shift}${secondary}, 0, movetoworkspacesilent, 10"
            # follow
